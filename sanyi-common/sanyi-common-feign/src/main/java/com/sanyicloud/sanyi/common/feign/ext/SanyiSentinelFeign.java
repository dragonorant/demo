 ...
 * @date 2020/6/9
 */
public final class SanyiSentinelFeign {

	private SanyiSentinelFeign() {
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new SanyiSentinelInvocationHandler(target, dispatch,
					...
					if (void.class != fallbackFactory) {
						...
						return new SanyiSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
					}
					return new SanyiSentinelInvocationHandler(target, dispatch);
				}
