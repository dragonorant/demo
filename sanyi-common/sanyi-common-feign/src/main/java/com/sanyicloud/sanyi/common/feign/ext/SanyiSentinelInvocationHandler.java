...
package com.sanyicloud.sanyi.common.feign.ext;
 ...
 */
@Slf4j
public class SanyiSentinelInvocationHandler implements InvocationHandler {
	...
	SanyiSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			SanyiSentinelInvocationHandler other = (SanyiSentinelInvocationHandler) obj;
